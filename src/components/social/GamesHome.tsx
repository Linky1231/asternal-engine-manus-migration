...
import { Flame, Rocket, Heart, Sparkles as SparklesIcon, Sparkles, Users, Gamepad2, Trophy, Joystick, Crown, Compass } from "lucide-react";
...
export function GamesHome({
  ...
  useEffect(() => {
    ...
    fetchGamePlayCounts24h(games.map(g => g.id))
      .then(r => { if (alive) setPlayCounts(r.counts); })
