...
de creación. Sus sistemas incluyen autoría asistida que crea planes de cambios
revisables, guardado y carga de proyectos, animaciones por estados y sprites,
efectos de sonido, utilidades de imagen y sincronización entre dispositivos.
...
export const ENGINE_MODULE_SUMMARY = {
  ...
  authoring: "Autoría: planes validados que modifican objetos, escena, física, colisiones y jerarquía.",
