...
# Texturas globales en la nube de Manus

- [x] Auditar las texturas actuales, sus URLs, componentes compartidos y referencias directas a Supabase.
- [x] Definir un catálogo global de texturas públicas y una textura activa compartida por todos los usuarios.
- [x] Servir y persistir exclusivamente los archivos de textura mediante almacenamiento Manus, sin filas ni buckets de Supabase.
- [x] Aplicar la textura global a todos los botones e iconos compatibles, conservando legibilidad, estados e iconografía.
- [x] Añadir pruebas de origen Manus, cobertura global y fallback accesible; validar preview, responsive y producción.
- [x] Guardar checkpoint y publicar la versión de texturas globales.


# Estado aplicado de texturas para artistas

- [x] Mostrar estado verde «Ya está puesta» cuando la textura global activa esté aplicada.
- [x] Mantener disponible el cambio, reemplazo y nueva subida aunque la textura ya esté aplicada.
- [x] Ocultar la textura pendiente del estado de selección sin eliminar la textura activa ni el fallback codificado.
